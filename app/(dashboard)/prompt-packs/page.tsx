        ...
        {filteredPacks.map((pack) => {
          ...
          return (
            <button
              ...
              className="group relative flex flex-col overflow-hidden rounded-xl border border-border bg-card p-6 text-left transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
            >
              {/* Gradient accent */}
              <div className={cn(
              ...
              <Badge 
                variant="outline" 
                className={cn("mb-3 w-fit capitalize", getCategoryColor(pack.category))}
              >
                {pack.category}
              </Badge>
              ...
              {/* Description */}
              <p className="mb-4 flex-1 text-sm text-muted-foreground/80 line-clamp-3">
                {pack.description}
              </p>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="flex items-center gap-1 text-sm font-medium text-primary opacity-0 transition-opacity group-hover:opacity-100">
                  Open Pack <ChevronRight className="h-4 w-4" />
                </span>
              </div>
            </button>
          )
