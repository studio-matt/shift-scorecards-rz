    ...
    return (
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-cyan/10 blur-3xl" />
        </div>
      ...
      <Card className="relative w-full max-w-md border-border/50 bg-card/80 backdrop-blur-xl">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4" data-lpignore="true">
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-primary to-primary/80 font-semibold shadow-lg shadow-primary/20 transition-all hover:shadow-primary/30"
              disabled={loading}
            >
